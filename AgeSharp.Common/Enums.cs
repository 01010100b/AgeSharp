namespace AgeSharp.Common
{
    ...
    {
        IGNORE = -1, DEFAULT, MOVE, PATROL, GUARD, FOLLOW, STOP, GROUND, GARRISON, DELETE, UNLOAD, TRAIN, GATHER, LOCK, WORK, UNGARRISON, DROP_RELIC, PACK, UNPACK, NONE
    }

    public enum UnitOrder
    {
        IGNORE = -1, ATTACK, DEFEND, BUILD, HEAL, CONVERT, EXPLORE, STOP,
    ...
    {
        IGNORE = -1, LINE = 2, BOX = 4, STAGGER = 7, FLANK = 8
    }

    public enum UnitStance
    {
        IGNORE = -1, AGGRESSIVE, DEFENSIVE, STAND_GROUND, NO_ATTACK
    }
