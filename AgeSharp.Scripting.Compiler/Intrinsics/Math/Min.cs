...
{
    internal class Min : Intrinsic
    {
        public override bool HasStringLiteral => false;

        public Min(Script script) : base(script)
        {
        ...
        protected override List<Instruction> CompileCall(Memory memory, Address? result, CallExpression call)
        {
            ...
            instructions.Add(new CommandInstruction($"up-modify-goal {memory.Intr0} g:min {memory.Intr1}"));
