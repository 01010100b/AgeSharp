...
{
    internal class BitwiseOr : Intrinsic
    {
        public override bool HasStringLiteral => false;

        public BitwiseOr(Script script) : base(script)
        {
        ...
        protected override List<Instruction> CompileCall(Memory memory, Address? result, CallExpression call)
        {
            ...
            instructions.Add(new CommandInstruction($"up-modify-flag {memory.Intr0} g:+ {memory.Intr1}"));
