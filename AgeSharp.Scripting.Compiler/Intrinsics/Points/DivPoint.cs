...
{
    internal class DivPoint : Intrinsic
    {
        public override bool HasStringLiteral => false;

        public DivPoint(Script script) : base(script)
        {
        ...
        protected override List<Instruction> CompileCall(Memory memory, Address? result, CallExpression call)
        {
            ...
            instructions.Add(new CommandInstruction($"up-modify-goal {memory.Intr0} g:z/ {memory.Intr2}"));
            instructions.Add(new CommandInstruction($"up-modify-goal {memory.Intr1} g:z/ {memory.Intr2}"));
