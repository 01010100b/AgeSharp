...
{
    internal class GetPointTerrain : Intrinsic
    {
        public override bool HasStringLiteral => false;

        public GetPointTerrain(Script script) : base(script)
        {
        ...
        protected override List<Instruction> CompileCall(Memory memory, Address? result, CallExpression call)
        {
            ...
            instructions.Add(new CommandInstruction($"up-get-point-terrain {memory.Intr0} {memory.Intr2}"));
